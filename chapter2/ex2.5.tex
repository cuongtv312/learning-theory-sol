\textbf{Exercise 2.5}
Assume that the density function of a distribution $\mathcal{D}$ is $(1-p)U(-1, 1) + pU(\frac{-1}{p}, \frac{1}{p})$ for $p \in (0, 0.5)$, where $U(.)$ denoted the density of the uniform distribution. Let $X_1,\dots, X_n$ be iid samples from $\mathcal{D}$. For $\epsilon > 0$, estimate the probability
...
&\Pr\Big[\bar{X} \ge \epsilon \Big] \le \exp\Big( \frac{-3 n \epsilon^2}{2(1-p+\frac{1+\epsilon}{p})} \Big)
\end{align*}
